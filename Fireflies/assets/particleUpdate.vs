...
//
//         See : http://www.cornflex.org/?p=1019
...
/*
 ...
 //if (noiseIteration >= 3.0) n += 0.25 * cnoise(v * 4.0 - vec3(0.0, 0.0, time*2.0));
 //if (noiseIteration >= 4.0) n += 0.125 * cnoise(v * 8.0 - vec3(0.0, 0.0, time*2.8));
 //if (noiseIteration >= 5.0) n += 0.0625 * cnoise(v * 16.0 - vec3(0.0, 0.0, time*4.0));
 //if (noiseIteration >= 6.0) n += 0.03125 * cnoise(v * 32.0 - vec3(0.0, 0.0, time*5.6));
 
 if (noiseIteration >= 1.0) n = snoise(v - noisePosition);
 if (noiseIteration >= 2.0) n += 0.5 * snoise(v * 2.0 - (noisePosition + vec3(0.0, 0.0, 1.4)));
 if (noiseIteration >= 3.0) n += 0.25 * snoise(v * 4.0 - (noisePosition + vec3(0.0, 0.0, 2.0)));
 if (noiseIteration >= 4.0) n += 0.125 * snoise(v * 8.0 - (noisePosition + vec3(0.0, 0.0, 2.8)));
 if (noiseIteration >= 5.0) n += 0.0625 * snoise(v * 16.0 - (noisePosition + vec3(0.0, 0.0, 4.0)));
 if (noiseIteration >= 6.0) n += 0.03125 * snoise(v * 32.0 - (noisePosition + vec3(0.0, 0.0, 5.6)));
...
void main()
{
    ...
    float zNoise = snoise(vec3(position.xz, uTime));
    
    // position = iPosition + vec3( xNoise, yNoise, zNoise );
    //vec3( sin(uTime), cos(uTime), 0 );
